...
class WorldFMRuntimeService:
    ...
    def start_session(self, init_image_base64: Optional[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            frame = self._build_session(session_id, init_image_base64, request_id=request_id)
    ...
    def _build_session(self, session_id: str, init_image_base64: Optional[str], *, request_id: str) -> str:
        runtime = self._require_runtime()
