...
TEXT_CFG_SCALE = float(os.environ.get("INFWORLD_TEXT_CFG_SCALE", "5.0"))
NUM_SAMPLING_STEPS = int(os.environ.get("INFWORLD_NUM_SAMPLING_STEPS", "30"))
SHIFT = 7  # PX256: 3, PX627: 7, PX960: 11
NUM_CHUNKS = int(os.environ.get("INFWORLD_NUM_CHUNKS", "13"))  # Number of video chunks to generate
...
PROMPTS_YAML = os.environ.get("INFWORLD_PROMPTS_YAML", os.path.join(PROJECT_ROOT, 'prompts', 'demo.yaml'))
...
def main():
    ...
    # Keep text encoder on CPU to reduce GPU memory pressure.
    text_encoder = get_obj_from_str(args.text_encoder_target)(device='cpu', **args.text_encoder_cfg)
