...
OUTPUT_PATH=./outputs/
MODEL_PATH=/mnt/server/WMFactory/.cache/huggingface/hub/models--tencent--HunyuanVideo-1.5/snapshots/9b49404b3f5df2a8f0b31df27a0c7ab872e7b038                   # Path to pretrained hunyuanvideo-1.5 model
...
AR_DISTILL_ACTION_MODEL_PATH=/mnt/server/WMFactory/.cache/huggingface/hub/models--tencent--HY-WorldPlay/snapshots/f4c29235647707b571479a69b569e4166f9f5bf8/ar_distilled_action_model/diffusion_pytorch_model.safetensors # Path to our HY-World 1.5 autoregressive distilled checkpoints
POSE='w-7'                    # Camera trajectory: pose string (e.g., 'w-31' means generating [1 + 31] latents) or JSON file path
NUM_FRAMES=29
WIDTH=832
HEIGHT=480
